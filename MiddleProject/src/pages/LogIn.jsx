            ...
            <section className='flex items-center justify-center' >
                <section className='max-w-[600px]  border border-gray-200 rounded-md p-8 m-4'>
                    <form className='flex flex-col items-center justify-between gap-y-3'>
                        ...
                        <Link to='/' type='submit' className='bg-violet-700 hover:bg-violet-800 rounded p-3 text-sm w-full  transition text-white cursor-pointer text-center' >Sign In</Link>
                    </form>
